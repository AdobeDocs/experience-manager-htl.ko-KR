...
>[!NOTE]
>
>[JavaScript Use API](https://github.com/adobe/htl-spec/blob/master/SPECIFICATION.md#42-javascript-use-api)는 이제 AEM as a Cloud Service에서 더 이상 사용되지 않습니다. 대신 [Java Use API](java-use-api.md)를 사용하십시오.
>
