...
1. **[Sling HTL 스크립팅 엔진](https://sling.apache.org/documentation/bundles/scripting/scripting-htl.html)** - Sling 프로젝트는 AEM에서 사용되는 HTL의 참조 구현을 만들었습니다. Sling 프로젝트에서 문서가 유지됩니다.
1. **[AEM 확장 기능](aem-extensions.md)** - AEM은 Sling HTL 스크립팅 엔진 위에 빌드되어 개발자에게 AEM과 관련된 편리한 기능을 제공합니다. 이들 확장 기능은 이 설명서 세트의 일부로 문서화되어 있습니다.
